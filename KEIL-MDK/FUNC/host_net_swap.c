...
{
    return isCPUBigEndian() ? host : BIGLITTLESWAP32(host);
}
...
{
    return isCPUBigEndian() ? net : BIGLITTLESWAP32(net);
}
...
{
    return isCPUBigEndian() ? host : BIGLITTLESWAP16(host);
}
...
{
    return isCPUBigEndian() ? net : BIGLITTLESWAP16(net);
}
