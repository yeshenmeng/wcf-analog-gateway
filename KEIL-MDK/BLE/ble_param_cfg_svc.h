...
typedef void (*ble_param_cfg_tx_power_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_param_cfg_adv_interval_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_param_cfg_adv_time_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_param_cfg_min_conn_interval_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_param_cfg_max_conn_interval_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_param_cfg_slave_latency_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_param_cfg_conn_timeout_write_handler_t) (uint8_t* p_data, uint16_t len);
