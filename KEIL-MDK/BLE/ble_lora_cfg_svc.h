...
typedef void (*ble_lora_cfg_freq_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_power_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_bw_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_sf_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_code_rate_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_preamble_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_header_write_handler_t) (uint8_t* p_data, uint16_t len);
typedef void (*ble_lora_cfg_crc_write_handler_t) (uint8_t* p_data, uint16_t len);
